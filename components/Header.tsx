        ...
        <div className="max-w-6xl mx-auto p-2">
            ...
            <section className="flex items-center space-x-2 py-5">
                <div className="h-16 w-16 sm:w-28 md:w-44 cursor-pointer flex-shrink-0">
                    <Link href={'/'}>
                        <Image className="h-full w-full object-contain" src={'https://links.papareact.com/bdb'}  alt={'ThirdWeb logo'} width={100} height={100}/>
                    </Link>
                </div>
                ...
                <div className="flex items-center space-x-2 px-2 md:px-5 py-2 border-black border-2 flex-1">
                    <GlobeIcon className="h-5 text-gray-400" />
                ...
                <Link href={"/create"}>
                    <button className="border-2 border-blue-600 px-5 md:px-10 py-2 hover:text-blue-600 hover:bg-blue-600/50 hover:text-white cursor-pointer duration-150">
                        List Item
                    </button>
                </Link>
            </section>
